...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyzxing-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12481&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyzxing-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyzxing` can be installed with:

```
conda install pyzxing
```

It is possible to list all of the versions of `pyzxing` available on your platform with:
